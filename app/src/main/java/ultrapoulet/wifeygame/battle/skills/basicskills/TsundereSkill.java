...
public class TsundereSkill extends AbsSkill {
    ...
    public String getDescription(BattleCharacter enemy) {
        String desc = "Damage Multiplier: " + String.format("%1$.2f", multiplier) + "x\n\n" +
                "Multiplies damage dealt by 2.00x if there are only 3 party members, 3.00x if there are only 2, 4.00x if this is the only wifey.";
        return desc;
    }
}
